...
description: 微信开发者工具 MCP - 使用 Node.js uniapp-wechat-mcp 通过官方 CLI 和 miniprogram-automator SDK 进行小程序构建、预览、截图、日志采集与自动化测试。适用于 uniapp 微信小程序，项目路径可自动发现 unpackage/dist/dev/mp-weixin。
---
